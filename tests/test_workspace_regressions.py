...
DESCI_BACKEND_PATH = DESCI_PATH / "backend"
...
for candidate in (DESCI_PATH, DESCI_BACKEND_PATH, NOTION_SCRIPTS_PATH, DAILYNEWS_SRC_PATH):
...
@patch("services.pdf_parser.pypdf.PdfReader")
