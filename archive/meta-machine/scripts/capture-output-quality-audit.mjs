...
function homeFirstRunGuidedStartSourceReady() {
  return sourceHasTerms("app.js", ["firstRunGuidedStartItems", "firstRunGuidedStartCoverage", "data-home-first-run-guided-start", "data-home-first-run-guided-start-item", "무엇을 관리하나", "다음 행동", "안전망 확인", "readyForExternalClaim"]) &&
