"""shared.circuit_breaker — Thread-safe three-state circuit breaker.

States:
  CLOSED    - requests flow normally; failures are counted
  OPEN      - requests are rejected immediately; re-checked after cooldown
...
logger = logging.getLogger("shared.circuit_breaker")
