...
| --- | --- | ---: | ---: |
| `launch_ready_product_hardening` | `covered_current_cycle` | `21` | `17` |
| `github_related_project_research` | `continuous` | `38` | `33` |
| `self_improving_autoresearch_skill` | `covered_current_cycle` | `4` | `2` |
| `continuous_ab_adoption_commit_push` | `continuous` | `13` | `11` |
