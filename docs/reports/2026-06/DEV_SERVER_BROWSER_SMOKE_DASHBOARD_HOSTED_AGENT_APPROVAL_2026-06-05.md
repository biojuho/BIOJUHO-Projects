...
- `PASS` `dashboard-frontend` `home` `/` expected=`15/15`

## Expected Text Evidence

- `dashboard-frontend` `home` matched=`15/15`
  ...
  - matched: `CREDENTIAL OPERATOR CHECKLIST`
  - matched: `0 ready / 5 blocked`
  - matched: `Checklist next`
  - matched: `Required env: missing`
  - missing: none
