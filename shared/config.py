...
# ---------------------------------------------------------------------------
WORKSPACE_ROOT = Path(__file__).resolve().parents[1]  # d:\AI 프로젝트
...
def get_project_root(name: str) -> Path:
    ...
    known_projects = {
        "agriguard": WORKSPACE_ROOT / "AgriGuard",
        "desci": WORKSPACE_ROOT / "desci-platform",
        "mcp_notion": WORKSPACE_ROOT / "MCP_notion-antigravity",
        "getdaytrends": WORKSPACE_ROOT / "getdaytrends",
