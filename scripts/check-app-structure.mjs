...
const {
  ...
  "pipeline-view.js": pipelineViewText,
...
const extractionCandidates = [
  ...
  },
  {
    id: "pipeline-view",
    owner: "pm-execution",
    terms: ["pipelineViewHelpers", "function renderPipeline", "pipelineViewCall(\"renderPipelineHTML\""],
    module: candidateModule("pipeline-view.js", pipelineViewText, ["JooParkPipelineView", "joopark-pipeline-view/v1", "function createPipelineView", "function pipelineViewModel", "function cellButton", "function renderPipelineHTML", "data-search-result=\"pm-pipeline\"", "searchEmptyState(\"pm-pipeline\"", "role=\"table\""]),
  },
  {
    id: "review-handoff",
