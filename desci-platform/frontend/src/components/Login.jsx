        ...
        <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden bg-[#040811]">
            ...
            >
                <div className="relative rounded-3xl overflow-hidden">
                    ...
                    <div
                        className="relative bg-surface/80 backdrop-blur-2xl rounded-3xl p-8 sm:p-10 border border-white/[0.06]"
                    ...
                    >
                        ...
                        <MotionButton
                            ...
                            className="w-full flex items-center justify-center gap-3 bg-white/[0.07] text-white font-medium py-3.5 px-4 rounded-xl hover:bg-white/[0.12] transition-all duration-300 border border-white/[0.08] hover:border-white/[0.15] active:scale-[0.98] disabled:opacity-40 disabled:cursor-not-allowed mb-8 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 focus-visible:ring-offset-2 focus-visible:ring-offset-surface group"
                        ...
                        >
                            ...
                            <span className="px-4 text-secondary text-xs uppercase tracking-[0.15em] font-medium">{t('login.orWithEmail')}</span>
                            <div className="flex-1 neural-line"></div>
                        </MotionDiv>
                        ...
                        <MotionForm
                            ...
                            className="space-y-5"
                            aria-label={isSignUp ? t('login.signUpForm') : t('login.signInForm')}
                        >
                            <Input
                                type="email"
                                label="Email"
                            ...
                            <Input
                                ...
                                helperText={isSignUp ? t('login.passwordHelper') : undefined}
                                value={password}
