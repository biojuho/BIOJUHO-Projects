                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-8">
                    ...
                    <div className="lg:col-span-4 bg-white/5 backdrop-blur-lg rounded-xl p-6 border border-white/10 shadow-lg h-fit">
                        ...
                        <select
                            ...
                            onChange={(e) => selectVc(vcList.find(v => v.id === e.target.value) ?? null)}
                            value={selectedVc?.id || ""}
                        >
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                {matches.map((match) => (
                                    <div
                                        ...
                                        className="bg-white/5 backdrop-blur-lg rounded-xl overflow-hidden border border-white/10 hover:border-purple-500 transition-all duration-300 hover:shadow-[0_0_25px_rgba(168,85,247,0.2)] shadow-lg group flex flex-col cursor-pointer h-full transform hover:-translate-y-1"
                                    >
                                        ...
                                        <div className="px-6 py-4 bg-black/30 border-t border-white/10 flex justify-between items-center mt-auto">
                                            ...
                                            <button
                                                onClick={e => { e.stopPropagation(); openDetail(match); }}
                    ...
                    >
                        ...
                        <div className="p-6 space-y-5">
                            <div>
                                ...
                                <p className="text-gray-300 leading-relaxed text-sm">{activeDetail.summary}</p>
                            </div>
                            <div className="bg-purple-900/20 border border-purple-700/30 rounded-xl p-4">
                                ...
                                <p className="text-gray-300 text-sm leading-relaxed">{activeDetail.match_reason}</p>
                            </div>
                            ...
                            <div className="flex items-center justify-between pt-2 border-t border-white/5 text-xs text-gray-500">
                                ...
                                {activeDetail.asset_id && (
                                    <span className="font-mono">ID: {activeDetail.asset_id.slice(0, 12)}...</span>
                                )}
                            </div>
                        </div>
                    </div>
