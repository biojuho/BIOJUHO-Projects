...
- **정치 제외 필터의 구조적 한계.** 커뮤니티는 정당·정치인을 실명 대신 줄임말·별칭으로 부르고(국짐, 개딸 …), 새 인물·단체는 계속 생긴다. 게시판 카테고리로도 못 거른다 — 정치 유머가 유머게시판에 올라온다. 2026-08-06에 "국짐이 정청래편인척"이 통과해 단어를 늘렸지만, 같은 라운드에서 "리박스쿨"처럼 아직 모르는 고유명사도 확인됐다. 키워드를 계속 쫓을지, 아니면 판정 방식을 바꿀지(예: 제목에 정치성 점수를 매겨 경계선은 사람이 확인) 정해야 한다.
