...
def main():
    ...
    parser.add_argument(
        "--output", default="docs/TECH_DEBT_INVENTORY.md", help="출력 파일 경로 (기본값: docs/TECH_DEBT_INVENTORY.md)"
    )
    parser.add_argument("--workspace", default=".", help="워크스페이스 루트 경로 (기본값: 현재 디렉토리)")
