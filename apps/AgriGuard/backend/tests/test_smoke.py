...
def test_nav_browser_smoke_tracks_mobile_first_viewport_affordances():
    ...
    assert script.MOBILE_ROUTE_AFFORDANCES["registry"][0]["min_bottom_margin"] == 16
...
def test_qr_path_browser_smoke_tracks_public_summary_first_viewport_targets():
    ...
    assert target_names == {
        ...
        "manual_verify_last_checked_card_first_viewport",
    }
    ...
    assert script.PUBLIC_VERIFY_SUMMARY_TARGETS[-1]["text"] == "Last checked"
