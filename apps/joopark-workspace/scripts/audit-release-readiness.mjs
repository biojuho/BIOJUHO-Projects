...
function buildChecklist() {
  ...
  checklist.push({
    ...
    requirement: "The portfolio includes BookStack as a researched self-hosted documentation benchmark candidate and interaction smoke can find it by current GitHub mirror commit with popularity and spike recommendation metadata.",
