...
- `python ops\scripts\run_workspace_smoke.py --scope desci --json-out apps\desci-platform\var\workspace-smoke-desci-external-gate-preflight-counts-2026-07-04.json`
  - `8 passed`, `0 failed`.
