...
class BioLinkerSettings(BaseSettings):
    ...
    # ── CORS ─────────────────────────────────────────────────────
    allowed_origins: str | None = Field(None, alias="ALLOWED_ORIGINS")

    # ── IPFS (Pinata) ────────────────────────────────────────────
    pinata_api_key: str | None = Field(None, alias="PINATA_API_KEY")
    pinata_api_secret: str | None = Field(None, alias="PINATA_API_SECRET")
    pinata_jwt: str | None = Field(None, alias="PINATA_JWT")
