...
class TapBoardBuilder:
    ...
    def _filter_opportunities(
        ...
        filtered = [
            item for item in opportunities if target_country in {country.lower() for country in item.target_countries}
        ]
    ...
    def _build_public_teaser(self, opportunity: ArbitrageOpportunity, target_country: str) -> str:
        ...
        return (
            f"{source}에서 먼저 뜬 '{opportunity.keyword}' 신호. {teaser_target} 시장에는 아직 빈 슬롯이 남아 있습니다."
        )
