"""
generation/system_prompts — 콘텐츠 생성 시스템 프롬프트 모음.
prompt_builder.py에서 분리. 각 페르소나/플랫폼별 시스템 프롬프트 정의.
"""
...
D. 영향 구체화: 이 변화가 누구의 비용, 시간, 선택지를 바꾸는지 직접 말하기
...
6. 공백 포함 **160자 이상 240자 이하** 단문 (한국어 기준). 이 범위 벗어나면 즉시 재작성
...
def _system_tweets_joongyeon() -> str:
    ...
    return (
        ...
        "Step 3 — 글쓰기 체크리스트 (각 트윗 **160~240자, 한국어 공백 포함**):\n"
...
def _system_tweets(tone: str) -> str:
    ...
    return (
        ...
        "**길이: 한글 기준 160~240자 (공백 포함). 미달·초과 모두 금지.**\n"
        "각 트윗은 다음을 모두 만족: ① 첫 문장 8단어 이내 강한 훅 ② 구체적 숫자·고유명사·시점 중 1개 이상 "
        "③ 독자가 동의/반박할 수 있는 명확한 입장 ④ 감정적 과장·낚시성 표현·해시태그 남발 금지 "
        "⑤ 같은 문장을 다른 단어로 반복 금지(빈 글자 메우기 금지).\n"
        "[JSON만 출력]\n"
        '{"topic":"주제","tweets":['
        '{"type":"공감 유도형","content":"160-240자","best_posting_time":"오전 8-10시","expected_engagement":"높음|보통|낮음","reasoning":"효과적인 이유 1문장"},'
        '{"type":"꿀팁형","content":"160-240자","best_posting_time":"...","expected_engagement":"...","reasoning":"..."},'
        '{"type":"찬반 질문형","content":"160-240자","best_posting_time":"...","expected_engagement":"...","reasoning":"..."},'
        '{"type":"동기부여형","content":"160-240자","best_posting_time":"...","expected_engagement":"...","reasoning":"..."},'
        '{"type":"유머/밈형","content":"160-240자","best_posting_time":"...","expected_engagement":"...","reasoning":"..."}]}'
    )
...
def _system_tweets_and_threads(tone: str) -> str:
    ...
    if tone == "joongyeon":
        return (
            _JOONGYEON_RULES + "\n\n"
            "[v17.0 앵글 기반 통합 생성]\n"
            "X 트윗 5종(한글 기준 160~240자, 공백 포함) + Threads 포스트 2종(500자 이내)을 동시 작성.\n\n"
            "[트윗 — 5개가 진짜 다른 글이어야 함]\n"
            ...
            "[JSON만 출력]\n"
            '{"topic":"주제","tweets":['
            '{"type":"반전|데이터펀치|자조공감|실용꿀팁|도발질문","content":"160-240자","best_posting_time":"오전 8-10시","expected_engagement":"높음|보통|낮음","reasoning":"이유 1문장"},'
            '{"type":"...","content":"...","best_posting_time":"...","expected_engagement":"...","reasoning":"..."},'
            '{"type":"...","content":"...","best_posting_time":"...","expected_engagement":"...","reasoning":"..."},'
            '{"type":"...","content":"...","best_posting_time":"...","expected_engagement":"...","reasoning":"..."},'
            '{"type":"...","content":"...","best_posting_time":"...","expected_engagement":"...","reasoning":"..."}],'
    ...
    return (
        ...
        "한 주제에 대해 X 트윗 5종(한글 기준 160~240자, 공백 포함)과 Threads 포스트 2종(500자 이내)을 동시 작성.\n\n"
        "[JSON만 출력]\n"
        '{"topic":"주제","tweets":['
        '{"type":"공감 유도형","content":"160-240자","best_posting_time":"오전 8-10시","expected_engagement":"높음|보통|낮음","reasoning":"효과적인 이유 1문장"},'
