...
async def run_add_empty_and_inspect():
    ...
    try:
        # 1. 빈 페이지 생성 (속성 없이)
        new_page = await notion.pages.create(parent={"database_id": ANTIGRAVITY_DB_ID}, properties={})
...
if __name__ == "__main__":
    asyncio.run(run_add_empty_and_inspect())
