...
def fetch_twitter_trends(topic: str, api_key: str, max_results=20):
    ...
    script_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), ".agents", "skills", "twitter-search", "scripts", "twitter_search.py")
...
def fetch_youtube_transcript(topic: str):
    ...
    script_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), ".agents", "skills", "youtube-intelligence", "scripts", "transcript_fetcher.py")
    if not os.path.exists(script_path):
