...
# Assuming this script runs from d:\AI 프로젝트\MCP_notion-antigravity\scripts\
...
def get_todays_commits():
    ...
    repo_root = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))  # d:\AI 프로젝트
