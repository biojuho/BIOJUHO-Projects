...
### Step 6: 일일 회고 및 최종 요약 제공

이번 세션의 DORA 지표 요약(가령 배포/커밋 횟수)을 포함하여 일일 회고를 제공한다.
